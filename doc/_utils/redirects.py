...
NRF = (
    # Directory-style URL redirects for toctree landing pages without index.rst
    ("app_dev/board_names/index", "app_dev/board_names"),
    ("app_dev/bootloaders_dfu/mcuboot_nsib/bootloader_mcuboot_nsib/index", "app_dev/bootloaders_dfu/mcuboot_nsib/bootloader_mcuboot_nsib"),
    ("app_dev/device_guides/coprocessors/hpf/index", "app_dev/device_guides/coprocessors/hpf"),
    ("app_dev/device_guides/fem/fem_software_support/index", "app_dev/device_guides/fem/fem_software_support"),
    ("app_dev/device_guides/nrf54h/ug_nrf54h20_architecture/index", "app_dev/device_guides/nrf54h/ug_nrf54h20_architecture"),
    ("app_dev/device_guides/nrf54h/ug_nrf54h20_ironside/index", "app_dev/device_guides/nrf54h/ug_nrf54h20_ironside"),
    ("app_dev/index", "app_dev"),
    ("applications/index", "applications"),
    ("dev_model_and_contributions/documentation/templates/index", "dev_model_and_contributions/documentation/templates"),
    ("dev_model_and_contributions/documentation/index", "dev_model_and_contributions/documentation"),
    ("dev_model_and_contributions/index", "dev_model_and_contributions"),
    ("drivers/wifi/index", "drivers/wifi"),
    ("drivers/index", "drivers"),
    ("installation/index", "installation"),
    ("integrations/index", "integrations"),
    ("libraries/bluetooth/mesh/gen_battery/index", "libraries/bluetooth/mesh/gen_battery"),
    ("libraries/bluetooth/mesh/gen_dtt/index", "libraries/bluetooth/mesh/gen_dtt"),
    ("libraries/bluetooth/mesh/gen_loc/index", "libraries/bluetooth/mesh/gen_loc"),
    ("libraries/bluetooth/mesh/gen_lvl/index", "libraries/bluetooth/mesh/gen_lvl"),
    ("libraries/bluetooth/mesh/gen_onoff/index", "libraries/bluetooth/mesh/gen_onoff"),
    ("libraries/bluetooth/mesh/gen_plvl/index", "libraries/bluetooth/mesh/gen_plvl"),
    ("libraries/bluetooth/mesh/gen_ponoff/index", "libraries/bluetooth/mesh/gen_ponoff"),
    ("libraries/bluetooth/mesh/gen_prop/index", "libraries/bluetooth/mesh/gen_prop"),
    ("libraries/bluetooth/mesh/light_ctl/index", "libraries/bluetooth/mesh/light_ctl"),
    ("libraries/bluetooth/mesh/light_ctrl/index", "libraries/bluetooth/mesh/light_ctrl"),
    ("libraries/bluetooth/mesh/light_hsl/index", "libraries/bluetooth/mesh/light_hsl"),
    ("libraries/bluetooth/mesh/light_xyl/index", "libraries/bluetooth/mesh/light_xyl"),
    ("libraries/bluetooth/mesh/lightness/index", "libraries/bluetooth/mesh/lightness"),
    ("libraries/bluetooth/mesh/models/index", "libraries/bluetooth/mesh/models"),
    ("libraries/bluetooth/mesh/scene/index", "libraries/bluetooth/mesh/scene"),
    ("libraries/bluetooth/mesh/scheduler/index", "libraries/bluetooth/mesh/scheduler"),
    ("libraries/bluetooth/mesh/sensor_models/index", "libraries/bluetooth/mesh/sensor_models"),
    ("libraries/bluetooth/mesh/time/index", "libraries/bluetooth/mesh/time"),
    ("libraries/bluetooth/mesh/vnd/dm/index", "libraries/bluetooth/mesh/vnd/dm"),
    ("libraries/bluetooth/mesh/index", "libraries/bluetooth/mesh"),
    ("protocols/bt/bt_mesh/fota/index", "protocols/bt/bt_mesh/fota"),
    ("protocols/index", "protocols"),
    ("releases_and_maturity/migration/migration_guide_2.4.99-cs3_to_2.6.99-cs2/index", "releases_and_maturity/migration/migration_guide_2.4.99-cs3_to_2.6.99-cs2"),
    ("releases_and_maturity/migration/migration_guide_nRF54H20_cs_to_2_7/index", "releases_and_maturity/migration/migration_guide_nRF54H20_cs_to_2_7"),
    ("releases_and_maturity/migration_guides/index", "releases_and_maturity/migration_guides"),
    ("releases_and_maturity/ncs_release_model/index", "releases_and_maturity/ncs_release_model"),
    ("releases_and_maturity/release_notes/index", "releases_and_maturity/release_notes"),
    ("releases_and_maturity/index", "releases_and_maturity"),
    ("samples/bl/index", "samples/bl"),
    ("samples/cellular/index", "samples/cellular"),
    ("samples/crypto/index", "samples/crypto"),
    ("samples/debug/index", "samples/debug"),
    ("samples/dect/index", "samples/dect"),
    ("samples/dfu/index", "samples/dfu"),
    ("samples/esb/index", "samples/esb"),
    ("samples/fast_pair/index", "samples/fast_pair"),
    ("samples/gazell/index", "samples/gazell"),
    ("samples/ironside_se/index", "samples/ironside_se"),
    ("samples/keys/index", "samples/keys"),
    ("samples/mesh/index", "samples/mesh"),
    ("samples/net/index", "samples/net"),
    ("samples/nfc/index", "samples/nfc"),
    ("samples/nrf5340/index", "samples/nrf5340"),
    ("samples/nrf93m1dk/index", "samples/nrf93m1dk"),
    ("samples/openthread/openthread_snippets/index", "samples/openthread/openthread_snippets"),
    ("samples/other/index", "samples/other"),
    ("samples/peripheral/index", "samples/peripheral"),
    ("samples/pmic/index", "samples/pmic"),
    ("samples/sensor/index", "samples/sensor"),
    ("samples/serialization/index", "samples/serialization"),
    ("samples/tfm/index", "samples/tfm"),
    ("samples/thread/index", "samples/thread"),
    ("samples/wifi/index", "samples/wifi"),
    ("samples/wifi_provisioning/index", "samples/wifi_provisioning"),
    ("samples/wifi_radiotest/index", "samples/wifi_radiotest"),
    ("samples/index", "samples"),
    ("scripts/index", "scripts"),
    ("security/index", "security"),
    ("templates/mesh_model_main_README/index", "templates/mesh_model_main_README"),
    ("test_and_optimize/optimizing/power/index", "test_and_optimize/optimizing/power"),
    ("test_and_optimize/index", "test_and_optimize"),
    ...
    ("libraries/bluetooth_services/services/fast_pair", "libraries/bluetooth/fast_pair/core"),
    ("libraries/bluetooth/services/fast_pair", "libraries/bluetooth/fast_pair/core"),
    ("libraries/bluetooth/services/fast_pair/index", "libraries/bluetooth/fast_pair/index"),
    ("libraries/bluetooth/services/fast_pair/core", "libraries/bluetooth/fast_pair/core"),
    ("libraries/bluetooth/services/fast_pair/adv_manager", "libraries/bluetooth/fast_pair/adv_manager"),
